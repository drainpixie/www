...
description: Some rules to work with me, as I'm a difficult person with strong preferences, rules, and boundaries.
date: 2025-09-02
---
...
It can be tedious, thus the usage of [Koji](https://github.com/cococonscious/koji) is recommended but not required for committing to my repositories.
...
This post is subject to change and should be a constant reference.  
